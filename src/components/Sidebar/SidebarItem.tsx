  ...
  return (
    <>
      <li>
        ...
        >
          <Icon className={`${pageName === item.label.toLowerCase() ? "text-primary dark:text-white" : "text-dark-4 hover:bg-gray-2 hover:text-dark dark:text-gray-5 dark:hover:bg-white/10 dark:hover:text-white"} w-6 h-6`} />
          {item.label}
          {item.message && (
